...
import { LayoutDashboard, TreePine, AlertTriangle, BarChart3, Leaf, Home, Shield, Map as MapIcon, User } from "lucide-react"
      ...
      <div className="border-t border-[#2d5016] p-4">
        <div className="flex items-center gap-3 rounded-lg bg-[#2d5016]/50 p-3 transition-all duration-200 hover:bg-[#2d5016]">
          ...
          <div className="flex flex-col">
            ...
            <span className="text-xs text-[#e8e6d9]">demo@rootsense.com</span>
          </div>
        </div>
      </div>
    </aside>
